<template>
  <div class="font-Poppins bg-black text-white scroll-smooth">
    <Navbar />
    <div class="hero">
    ...
    <div id="menu" class="h-full w-full text-center mt-20">
      <div
        data-aos="fade-up"
        class="menuTitle overflow-hidden text-3xl font-bold py-10"
      >
        Jelovnik
      </div>
      <div>
